      ...
      <div id="nav-fixed">
        <div className="container">
          <div className="nav-logo">
            <a href="/" className="logo"><img src="../static/img/logo.png" /></a>
          </div>
      ...
      <div id="nav-aside">
        ...
        <div className="section-row">
          ...
          <div className="post post-widget">
            <a className="post-img" href="blog-post.html"><img src="../static/img/widget-2.jpg" /></a>
          ...
          <div className="post post-widget">
            <a className="post-img" href="blog-post.html"><img src="../static/img/widget-3.jpg" /></a>
            <div className="post-body">
              <h3 className="post-title"><a href="blog-post.html">Why Node.js Is The Coolest Kid On The Backend Development Block!</a></h3>
            </div>
          </div>
          <div className="post post-widget">
            <a className="post-img" href="blog-post.html"><img src="../static/img/widget-4.jpg" /></a>
            <div className="post-body">
